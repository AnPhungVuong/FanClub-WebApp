package cst8218.assignemnt2.presentation;

import cst8218.assignemnt2.entity.AppUser;
import cst8218.assignemnt2.presentation.util.JsfUtil;
import cst8218.assignemnt2.presentation.util.PaginationHelper;
import cst8218.assignemnt2.AppUserFacade;
...
public class AppUserController implements Serializable {
    ...
    @EJB
    private cst8218.assignemnt2.AppUserFacade ejbFacade;
    ...
    public String update() {
        try {
            if (current.getPassword() == null || current.getPassword().trim().isEmpty()) {
                AppUser existingUser = getFacade().find(current.getId());
                current.setPassword(existingUser.getPassword());
            }
